...
const ProfileEdit = ({ user, onUpdate, onClose }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Subir avatar con datos del usuario
      const formDataUpload = new FormData();
      formDataUpload.append('avatar', selectedFile);
      formDataUpload.append('openproject_id', user.openproject_id);
      formDataUpload.append('name', user.name || formData.name);
      formDataUpload.append('email', user.email || formData.email);
      formDataUpload.append('roles', JSON.stringify(user.roles || formData.roles || []));

      console.log('Uploading avatar with user data...');
