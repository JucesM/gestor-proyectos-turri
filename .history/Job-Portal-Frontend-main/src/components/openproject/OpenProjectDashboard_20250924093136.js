      ...
      <main style={{
        ...
        <div>
          ...
          <div style={{
            ...
            {members
              .sort((a, b) => {
                // Function to check if a member has leadership roles
                const isLeader = (member) => {
                  const leadershipRoles = ['Project Admin', 'Manager', 'Project Manager', 'Líder', 'Leader', 'Administrator'];
                  return member.roles?.some(role =>
                    leadershipRoles.some(leaderRole =>
                      role.toLowerCase().includes(leaderRole.toLowerCase())
                    )
                  ) || false;
                };
