                ...
                return (
                  <div key={member.id} className="member-card">
                    <div className="member-avatar">
                      <img
                        src={getAvatarUrlSync(member.email || member.user || 'member', 'elegant')}
                    ...
                    <div className="member-info">
                      <div className="member-content">
                        ...
                        {currentTask ? (
                          <span className="task-badge">OVTHR-{currentTask.id}</span>
                        ) : (
                ...
                <div className="activity-list">
                  {[
                    ...
                    },
                    {
                      ...
                      issue: 'REL',
                      status: 'relacion',
                      message: 'Actualizar relación: OVTHR-131 ↔ OVTHR-133 (marca relación desde 131 a 133).'
                    },
                    {
                      user: 'Jhon',
                      avatar: '/api/placeholder/32/32',
                    ...
                    <div key={index} className="activity-item">
                      <img
                        src={getAvatarUrlSync(activity.user, 'robot')}
                        {...getAvatarAccessibilityAttrs(activity.user)}
