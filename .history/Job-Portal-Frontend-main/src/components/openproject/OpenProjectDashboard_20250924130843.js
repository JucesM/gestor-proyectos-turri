        ...
        <div style={{
          ...
          >
            <div style={{
              ...
              height: '40px',
              borderRadius: '50%',
              backgroundColor: userProfile?.avatar_url ? 'transparent' : '#E9E8E6',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              fontWeight: 'bold',
              color: '#143568',
              overflow: 'hidden',
              border: userProfile?.avatar_url ? '2px solid white' : 'none'
            }}>
            ...
            {members
              .sort((a, b) => {
                ...
                const getRolePriority = (member) => {
                  ...
                  if (role.includes('lider') || role.includes('leader') || role.includes('administrador') || role.includes('admin')) return 1;
                  if (role.includes('desarrollador') || role.includes('developer')) return 2;
                  if (role.includes('tester') || role.includes('qa')) return 3;
                  if (role.includes('analista') || role.includes('analyst')) return 4;
                  if (role.includes('diseñador') || role.includes('designer')) return 5;
