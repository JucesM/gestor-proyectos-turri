  ...
  return (
    <div className="dashboard">
      ...
      <div className="page-header">
        <h1 className="page-title">Actividades en proceso del equipo – {selectedProject?.name || 'Proyecto'}</h1>
                ...
                return (
                  <div key={member.id} className="member-card">
                    ...
                    <div className="member-info">
                      ...
                      <span className="task-badge">{currentTask ? `OVTHR-${currentTask.id}` : 'Sin tarea'}</span>
