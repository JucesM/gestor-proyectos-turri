...
const ProfileEdit = ({ user, onUpdate, onClose }) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // Crear o actualizar usuario directamente en BD local con datos disponibles
      console.log('Creating/updating user in local database...');
      ...
      const userData = {
        ...
        roles: user.roles || formData.roles
      };
      ...
      if (createResponse.ok) {
        ...
        console.log('User created/updated in local DB:', createData);
        // Actualizar el user con los datos guardados
        user = { ...user, ...createData.user };
      } else {
        console.warn('Failed to create/update user in local DB');
        console.warn('Create response status:', createResponse.status);
        console.warn('Create response text:', await createResponse.text());
        // Continuar de todas formas con los datos disponibles
      }
