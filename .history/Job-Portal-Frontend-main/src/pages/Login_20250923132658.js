  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${API_BASE_URL}/openproject/login`,
        { 
          username, 
          apiToken: password, // Mapeamos el campo password a apiToken
          // Incluimos ambos campos por compatibilidad
          password: password  // También enviamos el password por si el backend lo espera
        },
        { 
          headers: { 
          ...
          // Si tu backend usa sesiones con cookies, puedes descomentar esto:
