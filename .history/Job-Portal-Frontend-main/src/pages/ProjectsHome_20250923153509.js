...
const ProjectsHome = () => {
  ...
  const mockProjects = [
    { "id": "p1", "name": "Overthere", "leader": "Nicolas Garces" },
    { "id": "p2", "name": "SIMNET", "leader": "Felipe" },
    { "id": "p3", "name": "Vita", "leader": "Felipe" },
    { "id": "p4", "name": "Super Bien", "leader": "Hillary" },
    { "id": "p5", "name": "Trazabilidad", "leader": "Hillary" },
    { "id": "p6", "name": "Deguello", "leader": "Lizeth" }
  ];
  ...
  const handleProjectClick = (projectId) => {
    // For now, just show a toast. Later navigate to project detail
    toast.info(`Proyecto seleccionado: ${projects.find(p => p.id === projectId)?.name}`);
  };
